...
extern const int Reactor_window, Rail_window, Orb_window;
extern const int Controllroom_window_x, Reflector_window_x;
extern const int Controllroom_window_y, Reflector_window_y;

extern const int Reactor_half, Rail_half, Orb_half;
extern const int Controllroom_half_x, Reflector_half_x;
extern const int Controllroom_half_y, Reflector_half_y;
...
extern int Time, PreTime, ReactorEffect, Button[5], OrbType;
